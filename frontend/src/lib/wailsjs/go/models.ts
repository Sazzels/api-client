...
export namespace frontend {
	...
	export class EnvironmentHeaderDTO {
	    id: number;
	    // Go type: time
	    updatedAt: any;
	    key: string;
	    ...
	    static createFrom(source: any = {}) {
	        return new EnvironmentHeaderDTO(source);
	    }
	...
	export class EnvironmentDTO {
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.updatedAt = this.convertValues(source["updatedAt"], null);
	        this.name = source["name"];
	        this.header = this.convertValues(source["header"], EnvironmentHeaderDTO);
	    }
	...
	export class HttpRequestDto {
	    ...
	    disabledEnvironmentHeader: number[];
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.disabledEnvironmentHeader = source["disabledEnvironmentHeader"];
	    }
